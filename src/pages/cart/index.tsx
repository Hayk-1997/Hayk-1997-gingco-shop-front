            ...
            <div className="container">
                    <div className="row ">
                        ...
                        <div id="column-left" className="col-sm-4 col-lg-3 hidden-xs">
                            <div id="category-menu" className="navbar collapse in mb_40" aria-expanded="true"
                                 role="button">
                            ...
                            <div className="left_banner left-sidebar-widget mb_50 mt_30">
                                <a href="#">
                                <img src="images/left1.jpg" alt="Left Banner" className="img-responsive" />
                                </a>
                                </div>
                      ...
                      <button className="btn btn-danger" title="" data-toggle="tooltip" type="button" data-original-title="Remove">
                          <i className="fa fa-times-circle" />
                            ...
                            <p>Choose other products too or change selected products count or click Checkout to make an order.</p>
                            <div className="row">
