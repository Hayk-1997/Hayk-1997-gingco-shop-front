        ...
        <div id="column-left" className="col-sm-4 col-lg-3 hidden-xs">
            ...
            <div className="left-special left-sidebar-widget mb_50">
                ...
                <div id="left-special" className="owl-carousel owl-loaded owl-drag">
                    <div className="owl-stage-outer"><div className="owl-stage" style={{transform: 'translate3d(0px, 0px, 0px)', transition: 'all 0s ease 0s', width: '1110px'}}><div className="owl-item active" style={{width: '277.5px'}}><ul className="row ">
                    ...
                    </ul></div><div className="owl-item" style={{width: '277.5px'}}><ul className="row ">
                        <li className="item product-layout-left mb_20">
                            <div className="product-list col-xs-4">
                                <div className="product-thumb">
                    ...
                    </ul></div></div></div><div className="owl-nav"><div className="owl-prev disabled">prev</div><div className="owl-next">next</div></div><div className="owl-dots"><div className="owl-dot active"><span /></div><div className="owl-dot"><span /></div><div className="owl-dot"><span /></div><div className="owl-dot"><span /></div></div></div>
            </div>
        </div>
    )
}
