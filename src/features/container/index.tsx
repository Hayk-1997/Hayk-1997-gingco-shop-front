                          ...
                          <div className="product-thumb">
                            <div className="image product-imageblock">
                              <a href="https://html.lionode.com/darklook/product_detail_page.html">
                                ...
                                />
                                <Image
                                  src="/assets/images/product2-1.jpg"
                                  alt="product2-1.jpg"
                                  width={624}
                                  height={800}
                                />
                        ...
                        <div className="box-holder">
                          <div className="thumb post-img">
                            ...
                            <div className="post-info">
                              ...
                              <p>
                                Aliquam egestas pellentesque est. Etiam a orci
                                Nulla id enim feugiat ligula ullamcorper
                                scelerisque. Morbi eu luctus nisl.
                              </p>
                              <div className="view-blog">
                                <div className="write-comment pull-left">
                                  <a href="https://html.lionode.com/darklook/single_blog.html">
                                    0 Comments
                                  </a>
                                </div>
                      ...
                      <div className="item">
                        <div className="box-holder">
                          <div className="thumb post-img">
                            <a href="https://html.lionode.com/darklook/#">
                              {' '}
                              <img src="./blog_img_03.jpg" alt="themini" />{' '}
                            </a>
                            <div className="date-time text-center">
                              <div className="day"> 11</div>
                              <div className="month">Aug</div>
                      ...
                      <div className="item">
                        <div className="box-holder">
                          <div className="thumb post-img">
                            <a href="https://html.lionode.com/darklook/#">
                              {' '}
                              <img src="./blog_img_04.jpg" alt="themini" />{' '}
                            </a>
                            <div className="date-time text-center">
                              <div className="day"> 11</div>
                              <div className="month">Aug</div>
